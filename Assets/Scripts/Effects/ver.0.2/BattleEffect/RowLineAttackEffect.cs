...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class RowLineAttackEffect : BattleEffect, IValueChanger
    {
        public RowLineAttackEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        public override void Active()
        {
            ...
            new AttackStruct(AttackType.RowLine, NowPower, pos));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new RowLineAttackEffect(BattleEffectName, BasePower, MaxCooltime);
