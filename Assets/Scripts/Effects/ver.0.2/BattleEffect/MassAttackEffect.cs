...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class MassAttackEffect : BattleEffect, IValueChanger
    {
        ...
        public override void Active()
        {
            ...
            new AttackStruct(AttackType.All, NowPower, pos));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new MassAttackEffect(BattleEffectName, BasePower, MaxCooltime);
