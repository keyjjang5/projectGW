...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class CrossAttackEffect : BattleEffect, IValueChanger
    {
        ...
        public override void Active()
        {
            ...
            new AttackStruct(AttackType.FullCross, NowPower, pos));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new CrossAttackEffect(BattleEffectName, BasePower, MaxCooltime);
