...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class ColB2AttackEffect : BattleEffect, IValueChanger
    {
        public ColB2AttackEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        public override void Active()
        {
            ...
            new AttackStruct(AttackType.ColB2, NowPower, pos));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new ColB2AttackEffect(BattleEffectName, BasePower, MaxCooltime);
