...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class SingleAttackEffect : BattleEffect, IValueChanger
    {
        public SingleAttackEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        public override void Active()
        {
            ...
            new AttackStruct(AttackType.Single, NowPower, pos));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new SingleAttackEffect(BattleEffectName, BasePower, MaxCooltime);
