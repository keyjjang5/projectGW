...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class SingleMoveRightEffect : BattleEffect, IValueChanger
    {
        public SingleMoveRightEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        public override void Active()
        {
            ...
            new KnockbackStruct(KnockbackType.MoveRight, pos, NowPower));
        }

        public override BattleEffect DeepCopy()
        {
            BattleEffect battleEffect = new SingleMoveRightEffect(BattleEffectName, BasePower, MaxCooltime);
