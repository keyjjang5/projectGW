...
namespace GWEffectVer_0_2
{
    // 양산형 전투효과
    [Serializable]
    public class PlayerSelfShieldEffect : BattleEffect
    {
        public PlayerSelfShieldEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        {
            BattleEffect battleEffect = new PlayerSelfShieldEffect(BattleEffectName, BasePower, MaxCooltime);
