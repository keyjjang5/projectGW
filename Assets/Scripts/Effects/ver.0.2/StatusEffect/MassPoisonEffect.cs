...
{
    public class MassPoisonEffect : StatusEffect
    {
        // StatusEffectType과 Duration을 추가작성한다.
        public MassPoisonEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        {
            BattleEffect battleEffect = new MassPoisonEffect(BattleEffectName, BasePower, MaxCooltime);
        ...
        {
            StatusEffect statusEffect = new MassPoisonEffect(BattleEffectName, BasePower, MaxCooltime);
        ...
        public override void Active()
        {
            ...
            Hitbox.BroadcastMessage("AddStatusEffect2", new StatusStruct(this, pos, AttackType.All));
        }
