...
{
    public class SingleDefenseBreakEffect : StatusEffect
    {
        // StatusEffectType과 Duration을 추가작성한다.
        public SingleDefenseBreakEffect(string name = "default", int power = 0, int maxCooltime = 0) : base(name, power, maxCooltime)
        {
        ...
        {
            BattleEffect battleEffect = new SingleDefenseBreakEffect(BattleEffectName, BasePower, MaxCooltime);
        ...
        {
            StatusEffect statusEffect = new SingleDefenseBreakEffect(BattleEffectName, BasePower, MaxCooltime);
        ...
        public override void AddEffect()
        {
            ...
            Target.DamageCalculator.ChangeDef(value);
