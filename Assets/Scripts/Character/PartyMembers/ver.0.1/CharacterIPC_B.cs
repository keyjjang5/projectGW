...
[Serializable]
public class CharacterIPC_B : PartyMember
{
    public CharacterIPC_B(string name = "default", float maxhp = 100, int pos = 0) : base(name, maxhp, pos)
    {
        id = "C_006";
        SetImage();
        ...
        AddCard(new SingleAtk12Card(GetCharacter()));
        AddCard(new SingleAtk12Card(GetCharacter()));
        AddCard(new SingleAtk10KnockbackCard(GetCharacter()));
        AddCard(new SingleAtk10KnockbackCard(GetCharacter()));
    }

    public override Character DeepCopy()
    {
        PartyMember copy = new CharacterIPC_B();
