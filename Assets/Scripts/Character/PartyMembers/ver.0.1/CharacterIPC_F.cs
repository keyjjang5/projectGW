...
[Serializable]
public class CharacterIPC_F : PartyMember
{
    public CharacterIPC_F(string name = "default", float maxhp = 100, int pos = 0) : base(name, maxhp, pos)
    {
        id = "C_010";
        SetImage();
    ...
    {
        PartyMember copy = new CharacterIPC_F();
